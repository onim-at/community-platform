import{j as e}from"./jsx-runtime-CexXSJP5.js";import{C as b,a as j,F as u}from"./theme-ui-components.esm-BngKL4Rx.js";import{a as S,T,t as x,c as v,b as F}from"./TabsList-DhTEw6FA.js";import{n as g}from"./emotion-styled.browser.esm-Dz2BNYeh.js";import{I as C}from"./Icon-BIDCe2VJ.js";import{I}from"./InternalLink-Bo5i6YIm.js";import{S as w}from"./Select-Do5Sykw4.js";import{u as L,a as N,m as V}from"./index-CQ-1if_X.js";import{r as y}from"./index-BP8_t0zE.js";function $(e){return y.forwardRef((function(t,r){const{ownerState:n,...a}=t;return y.createElement(e,{...a,ref:r})}))}const m=t=>{const{tab:r,value:n}=t,{body:a,header:s,notifications:o}=r,i={borderRadius:3,marginBottom:4,padding:[2,4],overflow:"visible"};return e.jsxs(S,{value:n,style:{display:"flex",flexDirection:"column",alignSelf:"stretch"},children:[s&&e.jsx(b,{sx:{...i,backgroundColor:"softblue",padding:[3,5]},children:s}),o&&e.jsx(j,{sx:{...i,padding:0},children:o}),e.jsx(b,{sx:i,children:a})]})};try{m.displayName="SettingsFormTab",m.__docgenInfo={description:"",displayName:"SettingsFormTab",props:{tab:{defaultValue:null,description:"",name:"tab",required:!0,type:{name:"ITab"}},value:{defaultValue:null,description:"",name:"value",required:!0,type:{name:"string"}}}}}catch{}const d=e=>`/settings/${e.toLowerCase()}`,f=t=>{var r;const{currentTab:n,tabs:a}=t,s=L(),o=g(T)`
    color: grey;
    cursor: pointer;
